...
- For the full multi-cloud cost-engineering programme, use the [Model FinOps roadmap](/roadmaps/model-finops) and [Model FinOps and AI Cost Engineering](/articles/model-finops-cost-engineering-roadmap).
</WhenToUse>
...
4. Deepen with [Model FinOps and AI Cost Engineering](/articles/model-finops-cost-engineering-roadmap).
