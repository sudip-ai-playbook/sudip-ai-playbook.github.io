...
2. Harden APIs with the [API Security Engineering roadmap](/roadmaps/api-security-engineering) and [full guide](/articles/api-security-engineering-roadmap).
3. Assess adversarial risk with the [AI Red Teaming roadmap](/roadmaps/ai-red-teaming) and [full guide](/articles/ai-red-teaming-roadmap).
4. Build the full programme with the [Enterprise AI Security roadmap](/roadmaps/enterprise-ai-security) and [full guide](/articles/enterprise-ai-security-roadmap).
5. Wire evidence into [Evaluation and observability](./evaluation-observability).
