...
ISO/IEC 42001 defines requirements for establishing, implementing, maintaining and continually improving an organisation-wide AI management system. Its scope includes policies, objectives, responsibilities, lifecycle processes, monitoring and continual improvement.
