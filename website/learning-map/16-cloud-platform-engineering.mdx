...
- [AWS Learning Roadmap](/roadmaps/aws) · [Full guide](/articles/aws-roadmap)
- [Azure Learning Roadmap](/roadmaps/azure) · [Full guide](/articles/azure-roadmap)
- [Google Cloud Learning Roadmap](/roadmaps/gcp) · [Full guide](/articles/gcp-roadmap)
- [Architecture](/ai-solution-engineering/architecture)
...
2. Follow the [AWS Learning Roadmap](/roadmaps/aws), [Azure Learning Roadmap](/roadmaps/azure) or [Google Cloud Learning Roadmap](/roadmaps/gcp), or the full guides ([AWS](/articles/aws-roadmap), [Azure](/articles/azure-roadmap), [GCP](/articles/gcp-roadmap)).
3. Continue with [17. Security Engineering](./17-security-engineering).
