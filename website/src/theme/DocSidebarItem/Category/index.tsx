...
// Intentionally no-op: keep categories collapsed by default on every page,
// matching the articles sidebar. Users expand sections manually.
function useAutoExpandActiveCategory(_args: {
  isActive: boolean;
  collapsed: boolean;
...
function DocSidebarItemCategoryCollapsible({
  ...
  const {collapsed, setCollapsed} = useCollapsible({
    // Always honour sidebar `collapsed` — do not force-open the active category.
    initialState: () => {
      if (!collapsible) {
        return false;
      }
